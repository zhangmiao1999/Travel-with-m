package com.example.withm.widget;
...
import com.example.withm.utils.SystemUtils;
...
public class PreviewIndicator extends LinearLayout {
    ...
    public void initSize(int chosedSize,int nomal,int hei) {
        chooseSize = SystemUtils.dp2px(getContext(),chosedSize);
        nomalSize = SystemUtils.dp2px(getContext(),nomal);
        height = SystemUtils.dp2px(getContext(),hei);
    }
